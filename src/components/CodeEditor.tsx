      ...
      monaco.languages.setMonarchTokensProvider('mips', {
        tokenizer: {
          root: [
            ...
            [/\$[0-9]{1,2}/, 'variable'],
            [/\b(add\.s|add\.d|sub\.s|sub\.d|mul\.s|mul\.d|div\.s|div\.d|cvt\.s\.w|l\.s|s\.s|l\.d|s\.d|mov\.s|mov\.d|lw\.s|sw\.s)\b/, 'keyword'],
            [/\b(add|addu|sub|subu|and|or|xor|nor|slt|sltu|sll|srl|sra|sllv|srlv|srav|mult|multu|div|divu|mfhi|mflo|mthi|mtlo|jr|jalr|syscall|break|nop|mtc1|mfc1|swc1|lwc1|sdc1|ldc1|exit|loop)\b/, 'keyword'],
